...
export const uiText = {
  ...
  thuLibrary: {
    ...
    description:
      "Каждая запись — отдельная операция одной ведомости. Документы хранятся без ограничения по количеству.",
    add: "Добавить операцию",
    edit: "Редактировать операцию",
    empty: "Операций ТХУ-3 пока нет.",
  ...
  mmLibrary: {
    ...
    routeStart: "Окончание предыдущей бригады",
    routeEnd: "Сдача тепловоза (время или дата и время)",
    routeEndPlaceholder: "18:30 или 16.06.2026 18:30",
